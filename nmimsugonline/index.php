...
<div id="wrapper" class="">
    ...
    <section class="banner_section">
        <div class="main_banner">
            ...
            <div class="L-banner-box mobile_banner_box">
                <h2>B.Com and BBA <br />from NMIMS</h2>
                <h3>New Beginnings. Bold Futures</h3>
                <div class="f-box">
            ...
            <div class="container">
                <div class="banner_overlay">
                    <div class="L-banner-box">
                        <h2>B.Com and BBA from NMIMS</h2>
                        <h3>New Beginnings. Bold Futures</h3>
                        <div class="f-box">
                            <br /><br /><br />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <input type="text" name="contactno"
                                                ...
                                                id="txtContact<?php echo $mobileTextClass; ?>" onpaste="return false;"
        ...
        <div class="bfuture_ready_section">
            <div class="container">
                ...
                <div class="bfr_content">
                    <h2 class="heading01">
                        Digital <span class="r-color">Classroom, Real-World Impact</span>
                    </h2>
                    <span>Undergraduate programs designed to give you an early edge in your career!</span>
                    <p>
                        NMIMS CDOE brings to you the top-notch Bachelor of Commerce (B.Com) and
                        Bachelor of Business Administration (BBA) Programmes, right at your doorstep.
                        Delivered through Live Interactive Lectures using state-of-the-art online
                        infrastructure, these program will help you build a solid foundation for a
                        career in the corporate world or provide opportunities to pursue higher
                        education in commerce or management.
                    </p>
    ...
    <section class="section03">
        <div class="distance_learning_programme_section">
            <div class="container">
                <div class="DLP_block">
                    <h2 class="heading01W">Bachelor (Online) Specialisations</h2>

                    <div class="display-desktop">
                        <div id="horizontalTab">
                            <ul class="resp-tabs-list">
                                <li class="blue">Bachelor (Online) Specialisations</li>
                            </ul>
                            <div class="resp-tabs-container">
                                <div>
                                    <div class="pgdp-block">
                                        <div class="L-pgdp">
                                            <ul>
                                                <li><b>Bachelor of Commerce Specialisations</b></li>
                                                <li>Commerce</li>
                                                <li></li>
                                                <li></li>
                                            </ul>
                                        ...
                                        <div class="R-pgdp">
                                            <ul>
                                                <li><b>Bachelor in Business Administration Specialisations</b></li>
                    ...
                    <div class="dlp_slider display-mobile">
                        <div class="wow fadeInLeft">
                            <div class="DLP_box">
                                <h4 class="degree_head blue">Bachelor (Online) Specialisations</h4>
            ...
            <div class="container">
                <div class="a-center abt-block">
                    ...
                    <p>
                        ...
                        interactive learning on connected platforms 24/7. NMIMS CDOE is changing the dynamics of higher
                        education delivery in India while empowering students across India and enabling them to fulfil
