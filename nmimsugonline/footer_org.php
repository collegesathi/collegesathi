...
<div class="container-fluid section9">
	<div class="container">
			<h2>Copyright &copy; 2023, Amity University Online. All rights Reserved <a href="https://amityonline.com/amity/Home/Policies" style="color:#fff;float:right; text-decoration: none;" target="_blank">Privacy Policy</a></h2>
	</div>
</div>

<!-- Modal -->
<div class="modal fade mypopup" id="exampleModal5" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<h2>Thank you for showing your interest in our programme.</h2>
					<p>For more details, call 1800-102-3434</p>
					<a href="#">Apply Now</a>
				</div>
			</div>
		</div>
