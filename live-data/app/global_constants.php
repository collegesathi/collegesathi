...
define('TREND_IMAGE_URL', WEBSITE_UPLOADS_URL . 'specialization/');
define('TREND_IMAGE_ROOT_PATH', WEBSITE_UPLOADS_ROOT_PATH . 'specialization' . DS);
...
Config::set('REASON_ARRAY', array(
    1 => 'Search',
    2 => 'Study',
    3 => 'Support'
));

define('VIDEO_URL', WEBSITE_URL . 'videos/');