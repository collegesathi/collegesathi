                                ...
                                @foreach ($result as $record)
                                    ...
                                    <tr class="items-inner">
                                        ...
                                        <td data-th='{{ trans('messages.global.status') }}'>
                                            ...
                                            @if ($record->is_top == ACTIVE)
                                                <span class="label label-success">{{ trans('messages.global.top_gallery') }}</span>
                                                <br>
                                            @endif
                                                    ...
                                                    @if ($record->is_active)
                                                        ...
                                                        <li>
                                                            <a class="confirm_box waves-effect waves-block"
                                                                ...
                                                                data-confirm-heading="{{ trans('messages.admin.system.are_you_sure') }}">
                                                                    <i class="material-icons">block</i>{{ trans('messages.global.mark_as_inactive') }}
                                                            </a>
                                                        </li>
                                                    @else
                                                        <li>
                                                            <a class="confirm_box waves-effect waves-block"
                                                                ...
                                                                data-confirm-message="{{ trans('messages.admin.system.you_want_to_perform_this_action') }}"
                                                                data-confirm-heading="{{ trans('messages.admin.system.are_you_sure') }}">
                                                                    <i class="material-icons">done</i>{{ trans('messages.global.mark_as_active') }}
                                                            </a>
                                                        </li>
                                                    @endif
