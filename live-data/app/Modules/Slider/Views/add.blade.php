...
@section('content')
@section('breadcrumbs')
	{{ Breadcrumbs::render('slider-page-add') }}
@stop
<!-- Ckeditor -->
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    @if($universitySlider)
                    {{ Form::open(['role' => 'form','url' =>  route("UniversitySlider.save","$uni_id"),'files'=>true,'class' => 'mws-form']) }}
                    @else
                    ...
                    <div class="mt-20">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                false) }}
                                                {{ Form::text("data[$i][" . 'slider_title' . ']', '', ['class' =>
                                                'form-control ', 'id' => 'slider_title' . $i]) }}
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                {{ Form::textarea("data[$i][" . 'slider_text' . ']', '', ['class' =>
                                                'form-control ', 'id' => 'slider_text' . $i]) }}
                                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {{ Form::text('slider_url', null, ['class' => 'form-control']) }}
                                        </div>
                        ...
                        <div>
                            ...
                            @if($universitySlider)
                                <a href="{{ route('UniversitySlider.add',$uni_id) }}" class="text-decoration-none"><button type="button"
