...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        {{ Form::open(['method' => 'get', 'role' => 'form', 'route' => ["$modelName.job_requests",$type,$career_id], 'class' => 'mws-form']) }}
                    ...
                    <div class="panel-body">
                        <div class="row clearfix ">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{ Form::text('email_address', isset($searchVariable['email_address']) ? $searchVariable['email_address'] : '', ['class' => 'form-control', 'placeholder' => trans('messages.global.filter_by_email_address')]) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{ Form::text('mobile_number', isset($searchVariable['mobile_number']) ? $searchVariable['mobile_number'] : '', ['class' => 'form-control', 'placeholder' => trans('messages.global.filter_by_mobile_number')]) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix ">
                            <div class="col-xs-12 col-sm-6 col-md-4 pull-right set_button">
                                ...
                                <a href='{{ route("$modelName.job_requests",[$type,$career_id]) }}'><button type="button"
                ...
                <table class="table table-bordered table-striped table-hover ">
                    <thead>
                        <tr role="row">
                            ...
                            <th> {{ trans('messages.global.email_address') }} </th>
                            <th> {{ trans('messages.global.mobile_number') }} </th>
                                    ...
                                    <td data-th="{{ trans('messages.global.action') }}">
                                        <div class="btn-group m-l-5 m-t-5">
                                            ...
                                            <ul class="dropdown-menu  min-width-220">
                                                <li>
                                                    <a href="{{ route('Career.view_job_request', [$type,$record->id,$career_id]) }}"
