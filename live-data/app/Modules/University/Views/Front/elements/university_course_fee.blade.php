...
">
            ...
            @elseif(isset($slug) && isset($course_slug) && isset($specification_slug))
                <tr>
                    <th>{{ $specificationDetails->name }}</th>
                    <td class="text-center">{{ CustomHelper::displayPrice($specificationDetails->per_semester_fee)}}</td>
                    <td class="text-center">{{CustomHelper::displayPrice($specificationDetails->total_fee)}}</td>
                    <td class="text-end">{{CustomHelper::displayPrice($specificationDetails->one_time_fee)}}</td>
                </tr>
            @endif
        </tbody>
