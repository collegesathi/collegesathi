...
<li>
	<div class="card">
		...
		<div class="card-footer d-flex">
			...
			<a href="{{ route('University.frontIndex', $value->slug) }}" class="btn btn-primary">{{ trans('front_messages.global.view_details') }} </a>
		</div>
		{{-- <div class="card-footer">
			<a href="{{ route('University.frontIndex', $value->slug) }}" class="btn btn-primary">View details </a>
	</div> --}}
	</div>
</li>
@endforeach
