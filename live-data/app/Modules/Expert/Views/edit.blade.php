...
@section('content')
@section('breadcrumbs')
	{{ Breadcrumbs::render('expert-page-edit') }}
@stop
    <!-- Ckeditor -->
                        ...
                        <div class="mt-20">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group add-image image align-center">
                                            ...
                                            <span class="help-inline required profile_image" id="ContentTypeNameSpan">
                                                ...
                                                ?>
                                                <div id="pImage">
                                                    @if ($image != '' && File::exists(EXPERT_IMAGE_ROOT_PATH . $image))
                                                        <img src="{{ asset(EXPERT_IMAGE_URL . $result->image, $result->image) }}"
                                                            class="profileImage">
                                                    @else
                                            ...
                                            <div class="image_note">
                                                <strong>{{trans("messages.global.note")}} : </strong> {{trans("messages.global.upload_expert_image_size_note")}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {{ Form::label('name', trans('messages.global.name') . '<span class="required"> * </span>', ['class' => 'control-label'], false) }}
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {{ Form::label('designation', trans('messages.global.designation') . '<span class="required"> * </span>', ['class' => 'control-label'], false) }}
                                            {{ Form::text('designation', $result->designation, ['class' => 'form-control']) }}
                                        </div>
                                        <span class="error help-inline designation">
