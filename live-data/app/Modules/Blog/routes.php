...
Route::group(array('prefix' => ADMIN_ROUTE_PREFIX, 'namespace' => 'App\Modules\Blog\Controllers'), function () {
    Route::group(array('middleware' => ['web', 'App\Http\Middleware\PreventBackHistory', 'App\Http\Middleware\AuthAdmin']), function () {
        ...
        Route::get('blog-manager/featured-update-status/{id}/{status}',array('as'=>'Blog.featured','uses'=>'BlogController@updateFeaturedStatus'));
        ...
        Route::get('university-blog-manager/edit-blog/{id}/{uni_id}', array('as' => 'UniversityBlog.edit', 'uses' => 'BlogController@editBlog'));
        Route::post('university-blog-manager/edit-blog/{id}/{uni_id}', array('as' => 'UniversityBlog.update', 'uses' => 'BlogController@updateBlog'));
        Route::get('university-blog-manager/update-status/{id}/{status}/{uni_id}', array('as' => 'UniversityBlog.status', 'uses' => 'BlogController@updateBlogStatus'));
        Route::any('university-blog-manager/delete-blog/{id}/{uni_id}', array('as' => 'UniversityBlog.delete', 'uses' => 'BlogController@deleteBlog'));
        ...
        Route::get('university-blog-manager/view/{id}/{uni_id}', array('as' => 'UniversityBlog.view', 'uses' => 'BlogController@viewBlog'));
        Route::get('university-blog/remove-image/{id}/{image_type}/{uni_id}', array('as' => 'UniversityBlog.removeImage', 'uses' => 'BlogController@removeImage'));
