...
@section('breadcrumbs')
	{{ Breadcrumbs::render('specialization-edit') }}
@stop
   ...
   <div class="row clearfix" >
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="card">
            <div class="header">
               <h2>
                {{ isset($uni_id) && !empty($uni_id) ? CustomHelper::getUniversiryNameById($uni_id)." -> " : '' }}{{ trans("messages.$modelName.table_heading_edit") }}
               </h2>
            ...
            <div class="body">
                ...
                @if($universityBlog)
                {{ Form::model($result,['role' => 'form','url' =>  route("UniversityBlog.update",[$result->id,$uni_id]),'class' => 'mws-form','files'=>true]) }}
                @else
                        ...
                        <div class="form-group add-image image">
                           ...
                           <span class="help-inline required profile_image" id="ContentTypeNameSpan">
                              <?php
                                 ...
                                 ?>
                              <div id="pImage">
                                 @if($image !=''&& File::exists(TREND_IMAGE_ROOT_PATH.$image))
                                 {{ HTML::image(TREND_IMAGE_URL.$result->image, $result->image , array("class"=>"profileImage"  )) }}
                                 @else
                     ...
                     <div class="col-sm-6">
                        <div class="form-group align-center add-image image_1">
                           ...
                           <span class="help-inline required profile_image_1" id="ContentTypeNameSpan">
                              ...
                              <div id="pImage1">
                                 @if ($image != '' && File::exists(TREND_IMAGE_ROOT_PATH . $image))
                                 {{ HTML::image(TREND_IMAGE_URL . $image, $image, ['class' => 'profileImage']) }}
                                 @else
