        ...
        <div class="row">
            <div class="col-md-9">
                <div class="inner_page_banner blog_heading">
                    <span>{{ trans('front_messages.global.specialization') }}</span>
...
<section class="blog_listing_section">
    <div class="container">
        ...
        <div class="blog_banner_slider">
            <h2 class="blog_posts_heading">Featured Specialization</h2>
                        ...
                        <div class="featured_blog_content">
                            ...
                            <div class="blog_banner_icon">
                                ...
                                <div class="blog_btnbox">
                                    <a href="{{ route('Specialization.postView', $featured_post->slug) }}" class="btn btn-primary"> {{ trans('front_messages.global.read_more') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="trending_posts">
                ...
                <div class="collapse" id="collapseExample">
                    <ul class="trending_posts_listing">
                        ...
                        <li>
                            <h5><a href="{{ route('Specialization.postView', $trending_post->slug) }}">{{ isset($trending_post->title) ? $trending_post->title : 'N/A' }}</a>
                            </h5>
                            <div class="author_details">
