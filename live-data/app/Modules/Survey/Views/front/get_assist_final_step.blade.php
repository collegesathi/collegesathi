...
<section class="bg_gray access_contact_section ">
        ...
        <div class="details_access_main">
            <div class="details_logo_main access_column">
                <div class="bg-white details_logo_box">
                    <h3 class="chhh">Just one more step!<br>Enter your details to view your personalized recommendations
                    </h3>
                    <!-- <div class="details_logo_inner">
                        <ul class="image-carousel">
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo4.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo12.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo2.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo13.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo9.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo5.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo6.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo4.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo1.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo3.jpg" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}nmims-university-logo.png" alt=""></figure>
                            </li>
                            <li>
                                <figure><img src="{{ WEBSITE_IMG_URL }}Online-Education-logo11.jpg" alt=""></figure>
                            </li>
                        </ul>
                    </div> -->
    ...
    margin-bottom: 49px;
">
            <img src="/images/step-img.gif" alt="Centered Logo" class="rounded-image">
        </div>
            ...
            <div class="contact_details_box access_column">
                <div class="bg-white details_box_main">
                    <div class="bg-light d-flex fs-11 align-items-center justify-content-center gap-2 mt-0 flex-wrap py-3 shadow-sm rounded"
                        ...
                        <img src="/images/expertimages-01.svg" alt="Team image" style="width: 50px; height: auto;"
    ...
    'style' => 'border-radius: 0;',
                            ...
                            <span
                                class="fw-bold fs-11 position-absolute end-0 me-2 px-3 rounded-bottom text-success z-index-1"
                                style="bottom: -17px;background-color:#d4fee8"><svg stroke="currentColor"
                                    fill="currentColor" stroke-width="0" viewBox="0 0 16 16" font-size="12" height="1em"
                                    width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z">
                                    </path>
                                </svg>Privacy assured<!-- --> </span>
                            <span
...
">
                            ...
                            <p class="fs-11 text-center mt-3" style="padding: 0 15px;">
                                ...
                                <a href="https://www.collegesathi.com/pages/privacy-policy" target="_blank"
                                    style="color: #007bff;">Privacy Policy</a>,
                                <a href="https://www.collegesathi.com/pages/terms-conditions" target="_blank"
                                    style="color: #007bff;">Terms of Use</a>
                            </p>
                        </div>
                    </div>
