...
@section('breadcrumbs')
	{{ Breadcrumbs::render('city-add', $result) }}
@stop
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            {{ trans('messages.City.table_heading_add') }}
                        </h2>
                    ...
                    <div class="body">
                        {{ Form::open(['role' => 'form', 'url' => route('City.save', [$stateId]), 'class' => 'mws-form']) }}
                        <div class="mt-20">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <div> {{ $result->countryName->country_name }}</div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {{ Form::label('status', trans('messages.global.status') . '<span class="required"> * </span>', ['class' => 'control-label'], false) }}
                                            {{ Form::select('city_status', ['' => trans('messages.global.please_select_status'), ACTIVE => 'Active', INACTIVE => 'Inactive'], null, ['class' => 'form-control autocomplete', 'data-live-search' => 'true']) }}
                                        </div>
                                        <span class="error help-inline">
                                            <?php echo $errors->first('city_status'); ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <a href="{{ route('City.add', $stateId) }}" class="text-decoration-none"><button
