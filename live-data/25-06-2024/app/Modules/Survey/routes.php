...
Route::group(array('prefix'=>'','namespace'=>'App\Modules\Survey\Controllers\Front'), function(){
	Route::group(array('middleware' => ['web','App\Http\Middleware\PreventBackHistory','App\Http\Middleware\GuestFront']), function() {
		Route::get('/survey/get-assist/{expert_slug?}',  array('as' => 'survey.getAssist','uses'=>'SurveyController@getAssist'));
	    Route::post('/survey/save-degree-category',  array('as' => 'survey.saveDegreeCategory','uses'=>'SurveyController@saveDegreeCategory'));
		Route::get('/survey/get-assist-steps',  array('as' => 'survey.getAssistSteps','uses'=>'SurveyController@getAssistSteps'));
		Route::post('/survey/get-assist-steps-save',  array('as' => 'survey.getAssistStepsSave','uses'=>'SurveyController@getAssistStepsSave'));
		Route::get('/survey/get-assist-previous-steps',  array('as' => 'survey.getAssistPreviousStep','uses'=>'SurveyController@getAssistPreviousStep'));
		Route::get('/survey/get-assist-final-step',  array('as' => 'survey.getAssistFinalStep','uses'=>'SurveyController@getAssistFinalStep'));
