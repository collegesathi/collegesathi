...
@section('breadcrumbs')
	{{ Breadcrumbs::render('state-edit', $countryName) }}
@stop
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            {{ trans('messages.State.table_heading_edit') }}
                        </h2>
                    ...
                    <div class="body">
                        {{ Form::model($model, ['role' => 'form', route('State.update', [$countryId, $model->id]), 'class' => 'mws-form', 'files' => true]) }}
                        ...
                        <div class="mt-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {{-- {{ Form::select('country_name', ['' => trans('messages.State.please_select_country')] + $countryList, $countryIdNew, ['class' => 'form-control', 'data-live-search' => 'true']) }} --}}
                                        </div>
                            ...
                            <div>
                                ...
                                <a href="{{ route('State.edit', [$countryId, $model->id]) }}"
