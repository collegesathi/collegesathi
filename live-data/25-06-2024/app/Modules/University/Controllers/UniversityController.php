...
class UniversityController extends BaseController
{
    ...
    public function saveUniversity()
    {
        ...
        $validator = Validator::make(
            ...
            array(
                ...
                // 'university_facts.required' =>  trans('messages.university.university_facts_REQUIRE_ERROR'),
        ...
        if ($validator->fails()) {
            ...
            $model->display_order  = isset($thisData['display_order']) && !empty($thisData['display_order']) ? $thisData['display_order'] : INACTIVE;
    ...
    public function updateUniversity($modelId)
    {
        ...
        if ($validator->fails()) {
            ...
            $model->display_order  = isset($this_data['display_order']) && !empty($this_data['display_order']) ? $this_data['display_order'] : INACTIVE;
            if (Request::hasFile('image')) {
                $extension = Request::file('image')->getClientOriginalExtension();
                $fileName = time() . '-university-image.' . $extension;
                if (Request::file('image')->move(UNIVERSITY_IMAGE_ROOT_PATH, $fileName)) {
