        ...
        <div class="crousel_item">
            <div class="course_details eq_course_details card">
                ...
                <div class="card-footer">
                    <a href="{{ route('University.universityCourseDetail', [$slug, $courses->slug]) }}" class="btn btn-outline-primary">{{ trans("front_messages.global.read_more") }}</a>
                </div>
            </div>
        </div>
        @endif
