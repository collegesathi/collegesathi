...
<head>
    ...
    <script>
        ...
        fbq('init', '1741774749959534');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1741774749959534&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
    ...
    {{ HTML::style(WEBSITE_CSS_URL . 'swiper-bundle.min.css') }}
    ...
    {{ HTML::script(WEBSITE_JS_URL . 'swiper-bundle.min.js') }}
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WL3WX2KJ" height="0" width="0"
