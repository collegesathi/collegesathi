                        ...
                        <div class="row g-0">
                            <div class="col-md-5">
                                <div class="universities_img">
                                    <?php
                                    echo $image = CustomHelper::showImage(SLIDER_ROOT_PATH, SLIDER_URL, $programs->getSliders->isNotEmpty() ? $programs->getSliders[0]->slider_image : "", '', ['alt' => $programs->getSliders->isNotEmpty() ? $programs->getSliders[0]->slider_image : "", 'height' => '370', 'width' => '245', 'zc' => 1]);
                                    ?>
                                    ...
                                    <div class="top_universities_logo">
                                        <figure class="university_logo_explore_program">
                                            @if ($programs->image != '' && File::exists(UNIVERSITY_IMAGE_ROOT_PATH . $programs->image))
                                            <img src="{{ UNIVERSITY_IMAGE_URL . $programs->image}}" alt="image">
                                            @endif
                                            <?php
