	...
	<div class="explore-programm-wrap">
        ...
        @if (!empty($courseCategories))
            @foreach ($courseCategories as $courseKey => $courseValue)    
              <li class="nav-item" role="presentation">
                <button class="nav-link {{$courseKey == 1 ? 'active' : ''}}" id="tab{{$courseKey}}" data-bs-toggle="pill"
                  data-bs-target="#pills-{{$courseKey}}" type="button" role="tab"
        ...
        if (!empty($courseCategories)){
          foreach ($courseCategories as $courseKey => $courseValue){
            ...
            if(!empty($allCourses)){ 
      ?>
              <div class="tab-pane fade {{$courseKey == 1 ? 'active show' : ''}}" id="pills-{{$courseKey}}" role="tabpanel"
                aria-labelledby="tab{{$courseKey}}" tabindex="0">
                <div class="mob-tab-view">
                  ...
                  <div class="FlexnavBar">	
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                      ...
                      <li class="nav-item" role="presentation">
                        <button class="nav-link  {{ ($counter == 1) ? 'active' : '' }}" id="tab<?php echo $course->id; ?>"
                          data-bs-toggle="pill"
                          data-bs-target="#PGCourses-pills-<?php echo $course->id; ?>"
                          type="button" role="tab"
                          aria-controls="pills-<?php echo $course->id; ?>"
                    ...
                    <div class="tab-content">
                      ...
                      $count = 1;
                      foreach($allCourses as $course){ ?>
                      <div class="tab-pane fade {{ ($count == 1) ? 'show active' : '' }}" id="PGCourses-pills-<?php echo $course->id; ?>" role="tabpanel" aria-labelledby="tab<?php echo $course->id; ?>" tabindex="0">
                          ...
                          <?php if(!($course->coursesSpecifications->isEmpty())){ ?>
                            <div class="FlexnavBar SubFlexnavBar">	
                              <ul class="nav nav-pills" id="pills-tab" role="tablist">	
                                ...
                                <li class="nav-item" role="presentation">
                                  <button class="nav-link {{ ($cs == 1) ? 'active' : '' }}"
                                    id="tab<?php echo $coursesSpecification->id; ?>"
                                    data-bs-toggle="pill"
                              ...
                              <div class="tab-content">	
                                ...
                                $cs_1 = 1; 
                                foreach($course->coursesSpecifications as $coursesSpecification){ ?>
                                <div class="tab-pane fade {{ ($cs_1 == 1) ? 'show active' : '' }}" id="MBACourses-pills-<?php echo $coursesSpecification->id; ?>" role="tabpanel" aria-labelledby="tab<?php echo $coursesSpecification->id; ?>" tabindex="0">
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button collapsed" type="button"
                          data-bs-toggle="collapse" data-bs-target="#collapse{{$courseKey}}"
                          aria-expanded="false" aria-controls="collapse{{$courseKey}}">
                        {{$courseValue}}
                        </button>
                      </h2>
                      <div id="collapse{{$courseKey}}"
                                  ...
                                  <div class="accordion-item">
                                    <h2 class="accordion-header" id="PGSubheadingOne">
                                      <button class="accordion-button collapsed"
                                        ...
                                        data-bs-target="#PGSubcollapse{{$courseKey}}"
                                        aria-expanded="true"
                                                ...
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header"
                                                    ...
                                                    <button
                                                      ...
                                                      type="button"
                                                      data-bs-toggle="collapse"
                                                      data-bs-target="#MBASubcollapse{{$specificationKey}}"
                                                      aria-expanded="true"
                                                                ...
                                                                <a
                                                                  ...
                                                                  <div
                                                                    ...
                                                                    @if (isset($specificCourse->university->image) && File::exists(UNIVERSITY_IMAGE_ROOT_PATH . $specificCourse->university->image))    
                                                                      <figure>
                                                                        <img src="{{ UNIVERSITY_IMAGE_URL . $specificCourse->university->image }}"
                                                                          class="">
                                                                      </figure>
                                                                    @endif
