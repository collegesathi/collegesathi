<div class="card">
    ...
    <div class="card-body">
        ...
        <h4 class="card-title"><a href="{{ route('Specialization.postView', $blogData->slug) }}">{{ isset($blogData->title) ? $blogData->title : 'N/A' }}</a></h4>
        ...
        <div class="blog_banner_icon">
            <div class="blog_btnbox content_btn pt-0">
                <a href="{{ route('Specialization.postView', $blogData->slug) }}" class="btn-link">
            ...
            <div class="icon d-flex latest_postsicon share-wrapper">
                ...
                <div class="share-btns">
                    <a target="_blank" href="https://www.facebook.com/sharer.php?u={{ route('Specialization.postView', $blogData->slug) }}&amp;t={{ $blogData->title }}"><i class="fa fa-facebook-official fa-2x" aria-hidden="true"></i>
                    </a>
                    <a target="_blank" href="https://twitter.com/home/?status={{ $blogData->title }} - {{ route('Specialization.postView', $blogData->slug) }}"><i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i>
                    </a>
                    <a target="_blank" href="https://www.instagram.com/?url={{ route('Specialization.postView', $blogData->slug) }}"><i class="fa fa-instagram fa-2x" aria-hidden="true"></i>
                    </a>
                    <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('Specialization.postView', $blogData->slug) }}&amp;title={{ $blogData->title }}"><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i>
                    </a>
                    <a target="_blank" href="https://api.whatsapp.com/send?text=The text to share!={{ route('Specialization.postView', $blogData->slug) }}&amp;title={{ $blogData->title }}"><i class="fa fa-whatsapp fa-2x" aria-hidden="true"></i>
                    </a>
                </div>
            </div>
        </div>
