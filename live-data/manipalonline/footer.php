	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				...
				<p>Manipal University Jaipur (MUJ) was launched in 2011 on an invitation from the Government of
					...
					students’ classes began in April 2021. In addition to this, it started offering online BCom and MCom
			...
			<div class="col-md-4">
				...
				<ul class="footerlink">
					...
					<li>MA-JMC - Master of Arts In Journalism & Mass Communication</li>
				</ul>

			</div>
			<div class="col-md-4">
				<h2>Accreditation & Approvals</h2>
				<p>University Grant commission  (UGC) , National Institutional Ranking Framework (NIRF), All India
		...
		<div class="row mt-4">
			...
			<div class="col-md-5">
				...
				<h2>Contact Us</h2>
				<p>Manipal University Jaipur , Dehmi Kalan, Off Jaipur-Ajmer Expressway, Jaipur, (Raj.) Rajasthan 303007.</p>
			</div>
			<div class="col-md-4">
				<h2>Make A Step Towards A Success Journey</h2>
				<p><strong class="d-block">Have Any Query?</strong>
					Take academic Mentor Guidance</p>
			</div>
			<div class="col-md-3">
