                    ...
                    <div class="mt-20">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{ Form::label('university_advantages', trans('messages.global.university_university_advantages') ." (".trans('messages.global.online_university_advantages') .")". '<span class="required"> * </span>', ['class' => 'control-label'], false) }} {{ Form::textarea('university_advantages',
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div>
                                        {{ Form::label('collaborate_university_home_top', trans("messages.$modelName.collaborate_university_home_top") . '<span class="required">  </span>', ['class' => 'control-label'], false) }}
                                        <div class="form-check">
                                            @php
                                            $checked = '';
                                            $checked = isset($result->collaborate_university_home_top) && ($result->collaborate_university_home_top == 1) ? 'checked' : '';
                                            @endphp
                                            <input class="form-check-input" type="checkbox" id="collaborate_university_home_top" name="collaborate_university_home_top" value="1" {{ $checked }}>
                                            <label class="form-check-label" for="collaborate_university_home_top">{{ trans("messages.$modelName.collaborate_university_home_top") }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
