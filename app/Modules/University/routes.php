 ...
 */
 ...
 Route::group(array('namespace' => 'App\Modules\University\Controllers\Front'), function () {
    Route::group(array('middleware' => ['web', 'App\Http\Middleware\GuestFront']), function () {
        ...
        Route::get('university/{uni_slug}/{course_slug}', array('as' => 'University.universityCourseDetail', 'uses' => 'UniversityController@index'));
        ...
        Route::any('universities-list', array('as'=>'University.getAllNewUniversity', 'uses'=>'UniversityController@getAllNewUniversity'));

        Route::get('university/{uni_slug}/{course_slug}/{specification_slug}', array('as' => 'University.universityCourseSpecificationDetail', 'uses' => 'UniversityController@index'));
    });
});
...
Route::group(array('prefix' => ADMIN_ROUTE_PREFIX, 'namespace' => 'App\Modules\University\Controllers'), function () {
    Route::group(array('middleware' => ['web', 'App\Http\Middleware\PreventBackHistory', 'App\Http\Middleware\AuthAdmin']), function () {
       ...
       /*  Route::any('university-application-manager/delete-university/{id}', array('as' => 'UniversityApplication.applicationdelete', 'uses' => 'UniversityApplicationController@deleteUniversityApplication'));
        ...
        Route::get('semesters/{uni_id}/{course_id}/{specification_id?}', array('as' => 'Course.semester', 'uses'=>'CourseController@semester'));
        ...
        Route::any('mark-as-all-active-semester/{course_id}/{uid}/{specification_id?}', array('as'=>'Course.markAsAllActive', 'uses'=>'CourseController@markAsAllSemesterActive'));

        Route::any('mark-as-all-inactive-semester/{course_id}/{uid}/{specification_id?}', array('as'=>'Course.markAsAllInactive', 'uses'=>'CourseController@markAsAllSemesterInactive'));

        Route::get('course-specification/{uni_course_id}/{uni_id}/{specification_id}', array('as' => 'Course.courseSpecification', 'uses'=>'CourseController@editCourses'));
        Route::post('course-specification-save/{uni_course_id}/{specification_id}', array('as' => 'Course.saveCourseSpecification', 'uses'=>'CourseController@saveCourses'));
        Route::post('course-specification-update/{id}/{uni_course_id}/{specification_id}', array('as' => 'Course.updateCourseSpecification', 'uses'=>'CourseController@updateCourses'));
    }); 
});
