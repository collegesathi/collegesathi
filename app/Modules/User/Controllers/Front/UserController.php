...
class UserController extends BaseController
{
    ...
    public function login(){ 
        ...
        if (!Auth::user()) {
			...
			$redirectUrl    =   isset($formData['return_url']) ? $formData['return_url'] :(isset($url) && !empty($url) ? $url : route('home.index'));
            if (Request::isMethod('post')) {
                ...
                if ((isset($res['data']['status']) && $res['data']['status'] == ERROR) || (isset($res['status']) && $res['status'] == ERROR)) {
                    ...
                    $redirect_url = $redirect_url = (isset($res['data']['returnUrl']) && !empty($res['data']['returnUrl'])) 
                    ? $res['data']['returnUrl'] : (isset($res['returnUrl']) && !empty($res['returnUrl']) ? $res['returnUrl'] : route('home.index'));
