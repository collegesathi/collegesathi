...
@section('breadcrumbs')
	{{ Breadcrumbs::render('faq-page-add',$uni_id,$course_id) }}
@stop
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    @if($universityFaq)
                        {{ Form::open(['role' => 'form','url' =>  route("UniversityFaq.save","$uni_id"),'files'=>true,'class' => 'mws-form']) }}
                    @elseif($courseFaq)
                        {{ Form::open(['role' => 'form','url' =>  route("CourseFaq.save",["$uni_id","$course_id"]),'files'=>true,'class' => 'mws-form']) }}
                    @else
                        {{ Form::open(['role' => 'form','route' => "$modelName.save",'files'=>true,'class' => 'mws-form']) }}
                    @endif
                    ...
                    <div class="mt-20">	
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
												...
												{{ Form::textarea("answer",'', ['class' => 'form-control ','id' => 'answer']) }}
                                                <script>
                                                   $(function () {
							...
							<div class="col-sm-12">
								<div class="form-group">
									<div class="form-line">
										...
										{{ Form::text("faq_order",'', ['class' => 'form-control']) }}
									</div>
                        ...
                        <div>	
                            ...
                            @if($universityFaq)
                                <a href="{{ route('UniversityFaq.add',$uni_id) }}"  class="text-decoration-none"><button type="button" class="btn bg-blue-grey btn-sm waves-effect"><i class="material-icons font-14">refresh</i>{{ trans('messages.global.reset')}}</button></a>
                            @elseif($courseFaq)
                                <a href='{{ route("CourseFaq.add",[$uni_id,$course_id]) }}'  ><button type="button" class="btn bg-blue-grey text-decoration-none  waves-effect btn-sm"><i class="material-icons font-14">refresh</i>{{ trans('messages.global.reset') }}</button></a>
                            @else
