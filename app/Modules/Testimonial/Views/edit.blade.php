...
<div class="container-fluid" id="main-container">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                {{ Form::label($i.'_linkedin_url', trans("messages.$modelName.linkedin_url").'<span
                                                    class="required"> * </span>', ['class' => 'control-label'],false) }}
                                                {{ Form::text("data[$i][".'linkedin_url'."]",isset($multiLanguage[$i]['linkedin_url'])?$multiLanguage[$i]['linkedin_url']:'', ['class' =>
                                                'form-control',]) }}
                                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <span class="max_length_comment" id="rchars<?php echo $i;?>">{{ TESTIMONIAL_MESSAGE_LENGTH - strlen($result->comment) }}</span> {{
    ...
    <script>
        $(document).ready(function() {
            ...
            // $('.tesitmonial_length').keyup(function() {
