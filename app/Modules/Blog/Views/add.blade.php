      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="card">
            ...
            <div class="body">
               ...
               @if($universityBlog)
               {{ Form::open(['role' => 'form', 'url' => route("UniversityBlog.save", "$uni_id"), 'files' => true, 'class' => 'mws-form', 'id' => 'formSubmitData']) }}
            @else
               {{ Form::open(['role' => 'form', 'route' => "Blog.save", 'files' => true, 'class' => 'mws-form', 'id' => 'formSubmitData']) }}
            @endif
                  ...
                  <div class="row clearfix">
                     <div class="col-sm-6 align-center">
                        <div class="form-group add-image image">
                           ...
                           <span class="help-inline required profile_image" id="ContentTypeNameSpan">
                              <div id="pImage">
                                 <img src="{{WEBSITE_UPLOADS_URL}}user-profile-not-available.jpeg" alt="Blog image"
                                    class="profileImage" />
                              </div>
                           </span>
                           <br />
                           <div>
                              <a href="javascript:void(0)" data-placement="right" data-toggle="tooltip"
                                 data-placement="bottom" title="{{ trans('messages.global.image_tooltip_msg')}}"
                                 class="btn bg-teal btn-block btn-sm waves-effect changePhoto" rel="image">
                                 {{ trans('messages.global.upload_image') }} <span class="required"> * </span></a>
                           </div>
                     ...
                     <div class="col-sm-6 ">
                        <div class="form-group align-center add-image image_1">
                           <input name="image_1" id="profile_image_1" class="form-control image-input-file"
                              type="file" />
                           ...
                           <div>
                              <a href="javascript:void(0)" data-placement="right" data-toggle="tooltip"
                                 data-placement="bottom" title="{{ trans('messages.global.image_tooltip_msg') }}"
                                 class="btn bg-teal btn-block btn-sm waves-effect changePhoto" rel="image_1">
              ...
              @endforeach
               ...
               <div class="row clearfix">
                  ...
                  <div class="col-sm-12">
                     <div class="form-group">
                        <div class="form-line">
                           {{  Form::label('slug', trans("messages.$modelName.slug") . '<span class="required"> * </span>', ['class' => 'control-label'], false) }}
