        ...
        <div class="container">
            <div class="footer_navigation_main accordion" id="accordionExample">
                <div class="footer-navigation_listing">
                    <div class="footer_navigation">
                        ...
                        <a class="btn collapsed accordion_filter" data-bs-toggle="collapse" href="#collapseProducts"
                        ...
                        <div class="collapse accordion-collapse" id="collapseProducts" data-bs-parent="#accordionExample">
                            <ul>
                                ...
                                <li><a href="{{ route('Career.list') }}">{{ trans('front_messages.global.careers') }}</a>
                                </li>
                                <li><a href="{{ route('Contact.add') }}">{{ trans('front_messages.global.contact_us') }}</a>
                                </li>
                ...
                <div class="footer-navigation_listing">
                    <div class="footer_navigation">
                        <h4>Collegsathi</h4>
                        <a class="btn collapsed accordion_filter" data-bs-toggle="collapse"
                            href="#collapsetechnology_solutions" aria-expanded="false"
                            aria-controls="collapsetechnology_solutions">
                            Collegsathi
                        </a>
                        <div class="collapse accordion-collapse" id="collapsetechnology_solutions"
                            data-bs-parent="#accordionExample">
                            <ul>
                                <li><a
                                        href="{{ route('Scholarship.form') }}">{{ trans('front_messages.global.scholarships') }}</a>
                                </li>
                                <li><a href='{{ route("Referral.form") }}'>
                                        {{ trans('front_messages.global.referral') }}</a></li>
                                <li><a href="{{ route('Blog.frontIndex') }}">{{ trans('front_messages.global.blogs') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="footer-navigation_listing">
                    <div class="footer_navigation">
                        <h4>Other Links</h4>
                        <a class="btn collapsed accordion_filter" data-bs-toggle="collapse" href="#OtherLinks"
                            aria-expanded="false" aria-controls="OtherLinks">
                            Other Links
                        </a>
                        <div class="collapse accordion-collapse" id="OtherLinks" data-bs-parent="#accordionExample">
                            <ul>
                                <li><a
                                        href="{{ route('Page.cmsPages', 'about-us') }}">{{ trans('front_messages.global.about_us') }}</a>
                                </li>
                                <li><a
                                        href="{{ route('Page.cmsPages', 'terms-conditions') }}">{{ trans('front_messages.global.terms_conditions') }}</a>
                                </li>
                                <li><a
                                        href="{{ route('Page.cmsPages', 'privacy-policy') }}">{{ trans('front_messages.global.privacy_policy') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="footer-navigation_listing">
                    <div class="footer_navigation">
                        <h4>Universities</h4>
                        <a class="btn collapsed accordion_filter" data-bs-toggle="collapse" href="#collapseCompany"
                        ...
                        <div class="collapse accordion-collapse" id="collapseCompany" data-bs-parent="#accordionExample">
                            <ul>
                                ...
                                <li><a href="{{ route('Faq.frontIndex') }}">{{ trans('front_messages.global.faq') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="navigation_get_in_touch">
                    <div class="footer_navigation">
                        <h4>Get in Touch</h4>
                        <a class="btn collapsed accordion_filter" data-bs-toggle="collapse" href="#collapsegetintouch"
                            aria-expanded="false" aria-controls="collapsegetintouch">
                            {{ trans('front_messages.global.get_in_touch') }}
                        </a>
                        <div class="collapse information accordion-collapse" id="collapsegetintouch"
                            data-bs-parent="#accordionExample">
            ...
            'placeholder' => trans('front_messages.global.enter_email_address'),
                            ...
                            */ ?>
                            ...
                            <button
                                class="btn btn-primary subscribe_btn">{{ trans('front_messages.global.subscribe') }}</button>
...
<div class="footer_navigation_main footer_mega_menu accordion" id="accordionExample">
    ...
    @endif
        ...
        <div class="social_icon">
            <figure>
                <a href="{{ WEBSITE_URL }}">
                    <img src="{{ WEBSITE_IMG_URL }}logofooter.svg" alt="logo">
                </a>
            </figure>
            <ul class="social_listing">
                ...
                @if($google_plus_link)
                    <li>
                        <a target="_blank" href="{{ $google_plus_link }}"> <i class="fa fa-google-plus"
                ...
                @endif
                <li>
                        <a target="_blank" href="https://bsky.app/profile/collegesathi.bsky.social"> <i class="fa fa-butterfly" aria-hidden="true"></i></a>
                    </li>
            </ul>
    ...
    <div class="menubar-strip">
        <div class="container">
            <ul class="d-flex flex-wrap align-items-center justify-content-between p-0 m-0">
                ...
                <li>                  
                    <a href="https://wa.me/9785800008?text=Hello%20there!" class="whatsapp-button" target="_blank">
