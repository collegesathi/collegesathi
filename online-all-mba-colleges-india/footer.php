	...
	<div class="container">
		<div class="footer d-md-flex justify-content-between">
			<ul>
				...
				<li><a target="_blank" href="https://www.facebook.com/collegesathi/"><i class="fa fa-facebook"
							aria-hidden="true"></i>
					</a> <a target="_blank" href="https://www.youtube.com/@collegesathi"><i class="fa fa-linkedin"
							aria-hidden="true"></i>
					</a> <a target="_blank" href="https://www.instagram.com/collegesathicom/"><i class="fa fa-instagram"
							aria-hidden="true"></i>
					</a></li>
			...
			<div class="copyrite text-left">
				<div class="container">					
					<p style="
	margin-top: 44px;
">© 2024 All Rights Reserved. | <a href="privacy-policy.php" target="_blank">Privacy Policy</a></p>
				</div>
			</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="Inquire-head">
					<h2>Enquire Now</h2>
					<div class="admission-number"> Admission Number : <span><a
								href="tel:18008911987">18008911987</a></span></div>
				</div>
...
<div class="modal fade" id="exampleModal_univers" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content uni" style="
...
">
                ...
                <div class="modal-body">
                    <p>
                        Here is the first line of information.<br>
                        This is the second line of the paragraph.<br>
                        And finally, the third line of text to complete the paragraph.
                    </p>
                </div>
