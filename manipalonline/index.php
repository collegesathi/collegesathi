...
<head>
    ...
    <meta name="description"
        content="Manipal University Jaipur Online offers distance education courses for Online BA, BCA, BCom, MBA, MCA, MCom & MJMC in 2023">
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a href="#Prospects" class="anchor-link">Prospects</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
                ...
                <div class="col-lg-7 col-md-12">
                    <div class="banner-content wow fadeInUp">
                        ...
                        <h1>Enhance Your Career
                            <strong class="d-block">Pursuing Online Degree</strong>
                        </h1>
                        ...
                        <div class="course-highlight">
                            <h3>BBA | BCOM | BCA | MBA | MCA | MCOM | MJMC</h3>
                        </div>
                    </div>
                </div>
    ...
    <div class="organisation-ad-section">
        <div class="container">
            <div class="ad-blocker-card">
                <p>Admission closing soon. Seats are filling fast! There's only limited seats available.</p>
                        ...
                        <li>
                            <div class="program-card">
                                ...
                                <div class="course-info">
                                    ...
                                    <span><i class="fa fa-gear"></i>12th Passed</span>
                        ...
                        <li>
                            <div class="program-card">
                                ...
                                <div class="course-info">
                                    ...
                                    <span><i class="fa fa-gear"></i>Graduation</span>
                        ...
                        <li>
                            <div class="program-card">
                                ...
                                <div class="headprogram">
                                    ...
                                    <h4>Master of Journalism & Mass Communication</h4>
                                </div>
                                <div class="course-info">
                                    <span><i class="fa fa-clock-o"></i> 2 Year</span>
                                    <span><i class="fa fa-gear"></i>Graduation</span>
