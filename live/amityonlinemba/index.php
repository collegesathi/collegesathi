...
">
											<li>
												<div class="form-row form-div form-bottom-1">
													<div class="form-group col-md-12 unit" >
													 <input  class="form-control" type="text" name="name" id="txtName" oncopy="return false;" placeholder="Name" onkeypress="return  OnlyAlphaValidationWithSpace(event)">
													</div>
												</div>
											</li>							
																						<li>
											<div class="form-row form-div form-bottom-1">
												<div class="form-group col-md-12 unit">
												<input class="form-control contactno <?php echo $mobileTextClass; ?>" name="contactno" id="txtContact<?php echo $mobileTextClass; ?>" onchange="SendOTP('<?php echo $mobileTextClass; ?>')" onpaste="return false;" oncopy="return false;" maxlength="10" placeholder="Mobile Number*" onkeypress="return isNum(event)">
												</div>
											 </div>
											 <div id="dvotp" class="form-row form-div form-bottom-1 row-btm">
				...
				<div class="col-md-5 dontshowonphonee">
					...
					<div style=" background: #fff; padding: 5px 0; margin-bottom: 10px;">
						<div class="row">
							...
							<div class="col-md-6 col-6">
								<p style="color: #043e7a; font-size: 18px; font-family: 'Inter!important', sans-serif; margin: 0;">&#8377; 49,750/-</p>
							</div>
						</div>
					</div>
					...
					<div style="    background: #043e7a; padding: 5px 0; margin-bottom: 10px;">
						<div class="row">
							...
							<div class="col-md-6 col-6">
								<p style="color: #fff; font-size: 18px; font-family: 'Inter!important', sans-serif; margin: 0; float:left!important;">&#8377; 1,99,000/-</p>
							</div>
						</div>
					</div>
				</div>
...
<div class="p-2 text-center text-dark" style="width: 100%; background-color:#F9C300;">
	...
	<!--   Request a Callback-->
	<!--</button>    -->
	<button type="button" class="btn text-center phonebtn2"  style="background-color: white; color: #FFFFFF; font-size: 18px; font-weight: 600; width: 20%; padding: 7px; margin: 0px auto; border-radius: 20px;">
	<a href="tel:+918290977727">Request a Callback</a>
</button>
