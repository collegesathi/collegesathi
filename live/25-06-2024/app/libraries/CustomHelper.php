...
class CustomHelper
{
    ...
    public static function getMasterDropdown($drop_down, $order_by_field = 'name', $order_direction = "ASC")
    {
        ...
        $master = DropDown::where('dropdown_type', $drop_down)->where('status', (int) ACTIVE)->orderby($order_by_field, $order_direction)->pluck('name', 'id')->toArray();
     ...
     *
     * @return null*/
    public static function getTestimonial($uni_id = null, $limit = TESTIMONIAL_HOME_PAGE_LIMIT)
    {
    ...
    public static function getSemesterData($uni_id, $course_id, $semester)
    {
        $getSemesterData = Semester::where('uni_id', $uni_id)->where('course_id', $course_id)->where('semester', $semester)->get();
    ...
    public static function getCoursesWithUniversityCount()
    {
        $courses = DropDown::with('getCoursesDetails')->where('dropdown_type', 'course')->get();
        return $courses;
    }
    ...
    {
        $featuredCourses = Course::with(['getUniversityDetails', 'getCourseDropDownDetails'])->where('is_featured', ACTIVE)->get();
     ...
     * @return array
     * */
    public static function getSemesterCreditTotal($course_id = null, $semester = null)
    {
        // echo $course_id .'        '. $semester; die; 
        $credit_score = "";
        $credit_score = Semester::where('course_id', $course_id)->where('semester', $semester)->sum('credit_score');
