                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {{ Form::text('department', $result->department, ['class' => 'form-control']) }}
                                        </div>
                                        <span class="error help-inline">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<div class="form-line">
											...
											{{ Form::select('job_type',array(''=>trans("messages.global.please_select_job_type"))+$jobTypeList, $result->job_type, ['class' => 'form-control show-tick','id'=>'job_type','data-live-search'=>"true"]) }}
										</div>
										<span class="error help-inline">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {{ Form::select('experience',array(''=>trans("messages.global.please_select_experience"))+$experienceList,$result->experience, ['class' => 'form-control show-tick','id'=>'experience','data-live-search'=>"true"]) }}
                                        </div>
                                        <span class="error help-inline">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {{ Form::text('location', $result->location, ['class' => 'form-control']) }}
                                        </div>
                                        <span class="error help-inline">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<div class="form-line">
											...
											{{ Form::textarea('job_responsibilities', $result->job_responsibilities, ['class' => 'form-control ', 'id' => 'job_responsibilities']) }}
											  <script>
												$(function() {
								...
								<div class="col-sm-12">
									<div class="form-group">
										<div class="form-line">
											...
											{{ Form::textarea('qualification', $result->qualification, ['class' => 'form-control ', 'id' => 'qualification']) }}
											 <script>
												$(function() {
