...
@section('breadcrumbs')
	{{ Breadcrumbs::render('setting-add') }}
@stop
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
										...
										{{ Form::select('input_type',array(''=>'Please Select Input Type')+ Config::get('input_type'),null, ['class' => 'form-control','data-live-search'=>"true"]) }}
