            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5 btn-right-top-margin">
                        <li>
                            <a href='{{ route("$modelName.listCourse", $result->univercity_id) }}'>
                ...
                <div class="body">
                    ...
                    <input type="hidden" name="univercity_id" value="{{ $result->univercity_id }}">
                    <div class="mt-20">
                        <div class="row clearfix">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        {{ Form::textarea('about_course', $result->about_course, ['class' => 'form-control','rows' => 2]) }}
                                        <script>
                                            $(function() {
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        {{ Form::textarea('management_specialisations',$result->management_specialisations, ['class' => 'form-control ', 'id' => 'management_specialisations']) }}
                                        <script>
                                            $(function() {
