...
class BlogController extends BaseController{
    ...
    public function index() {
        ...
        return View::make("Blog::front.index", compact( 'result', 'searchVariable', 'sortBy', 'order', 'metaTitle', 'meta_description', 'meta_keywords',  'formData','last_page','blogResult','search_string','trending_posts','featured_posts','pageTitle'));
    } //end index()
