...
<div class="banner-section  data-img-bg" data-image-src="images/banner-image.png">
	<div class="container">
		<div class="row">
			<div class="col-lg-7 col-md-6">
				<div class="banner-content">
					...
					<a href="#" class="btn btn-primary"><b>Admission open</b></a>
				</div>
			</div>
					...
					<div class="inquire-box">
						...
						<div class="inquire-form">
							<form class="servicefrm" name="servicefrm">
								...
								<input type="hidden" id="mx_Website_Page" name="mx_Website_Page" value="Enquire Now">
	...
	<div class="universities-section">
		...
		<li>
				<div class="universities-box">
					<figure><img src="images/nmims-university-logo.png" alt="image"></figure>
					<h3>MBA | 24 Months</h3>
			...
			<li>
				<div class="universities-box">
					<figure><img src="images/op_jindal.png" alt="image"></figure>
					<h3>MBA | 12 Months</h3>
