									...
									<ul>
										...
										<li>
											...
											<input type="text" name="contactno"
												...
												id="txtContact<?php echo $mobileTextClass; ?>" onchange="SendOTP('<?php echo $mobileTextClass; ?>')" onpaste="return false;"
											...
											<div class="form-group" id="dvotp" style="
    margin-top: 8px;
">
<label>OTP</label>
												<div class="position-relative">
													<div class="otp-container" style="width: 100%; max-width: 400px;">
														<input type="text" id="txtotpmobile01" maxlength="6"
															...
															style="width: 100%; padding: 5px; margin-bottom: 10px; border: 1px solid #ccc; font-size: 14px;"
															autocomplete="off">														
													</div>
												</div>
											</div>
								...
								<!-- <div class="send-box btnsubmit inputID online-mba-submit"> -->
									...
									<!-- <input id="btnSubmit" type="submit" name="submit" value="SUBMIT"
										class="btnsubmit inputID online-mba-submit" style="margin-top: 15px; padding: 13px 23px;
	width: auto;
	color: #ffffff;
	cursor: pointer;
	background: #d02f38;
	...
	outline: none;" />
            ...
            <div class="bfuture_ready_section">
                <div class="container">
                    ...
                    <div class="bfr_content">
                        <h2 class="heading01">
                            Future-<span class="r-color">Proof Your Skills</span>
                        </h2>
                        <span>Top MBA (WX) degree to give you an edge in today's competitive professional world!</span
              >
              <p>
                The program offers academic excellence, interactivity and flexibility of learning, thus allowing participants to broaden their career horizons. The 2 year, 90 credit, program is designed to build your academic forte in the initial months, followed by immediate application with a Capstone Business Simulation Project and an industry project.
              </p>
      ...
      <section class="section03">
        <div class="distance_learning_programme_section">
          <div class="container">
            <div class="DLP_block">
              <h2 class="heading01W">MBA (WX) Specialisations</h2>

              <div class="display-desktop">
                <div id="horizontalTab">
                  <ul class="resp-tabs-list">
                    <li class="blue">MBA (WX) Specialisations</li>
                  </ul>
              ...
              <div class="dlp_slider display-mobile">
                <div class="wow fadeInLeft">
                  <div class="DLP_box">
                    <h4 class="degree_head blue">MBA (WX) Specialisations</h4>
            ...
            <div class="aboutnmims_section">
                <div class="container">
                    <div class="a-center abt-block">
                        ...
                        <p>
                            NMIMS CDOE is the distance and online education centre of NMIMS University. NMIMS CDOE began its ODL & OL journey in 2013 with a state of the art learning management system to provide interactive learning on connected platforms 24/7. <br/><br/>NMIMS CDOE is changing the dynamics of higher education delivery in India while empowering students across India and enabling them to fulfil their dreams and aspirations.
                        </p>
                    </div>
