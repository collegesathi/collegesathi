...
@section('content')
@section('breadcrumbs')
	{{ Breadcrumbs::render('advertisement-page-add') }}
@stop
                    ...
                    <div class="body">
                        ...
                        <div class="mt-20">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line cstm_object">
                                            {{ Form::label('Option', trans("messages.$modelName.location") . '<span class="required"> * </span>', ['class' => 'control-label'], false) }}
                                            <div id="city_div">
                                                {{ Form::select('location', ['' => trans("messages.$modelName.please_select_location")] + $location, null, ['class' => 'form-control show-tick', 'id' => 'location', 'data-live-search' => 'true']) }}
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {{ Form::text('advertisement_url', null, ['class' => 'form-control']) }}
                                        </div>
