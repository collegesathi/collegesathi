...
@section('content')
    ...
    <div class="career-section py-5">
        <div class="container">
            ...
            <div class="videobanner-career mb-5">
                <video controls="">
                    <source src="{{ VIDEO_URL . 'career-new-video.mp4' }}" type="video/mp4">
                    <source src="{{ VIDEO_URL . 'career-video.ogv' }}" type="video/ogg">
                    <source src="{{ VIDEO_URL . 'career-video.webm' }}" type="video/webm">
                </video>
            </div>
                    ...
                    <div class="form-box">
                        <form class="form" id="career_apply_form" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-sm-6 g-recaptcha-box">
                                ...
                                <span
                                    class="error  help-inline g-recaptcha-response_error career-g-recaptcha-response_error"
