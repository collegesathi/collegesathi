...
class CareerController extends BaseController
{
    ...
    public function index()
    {
        ...
        $result = $query->orderBy('created_at','DESC')->paginate((int)CAREER_PAGE_DEFAULT_LIMIT);
    ...
    {
        $result = Career::where('is_active', ACTIVE)->orderBy('created_at','DESC')->paginate((int)CAREER_PAGE_DEFAULT_LIMIT);
