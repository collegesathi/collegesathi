    ...
    <div class="login-register">
        <div class="container">
            <div class="form-box">
                ...
                <p>{{ trans('front_messages.global.create_a_new_collegesathi_account') }}</p>
                ...
                <div class="form_col_12">
                    {{ Form::password('password', ['class' => 'userPassword form-control', 'placeholder' => trans("front_messages.global.password")]) }}
                    <span class="error help-inline user_signup_password_error password">
                        {{ $errors->first('password') }}
                    </span>
                </div>
                <div class="form_col_12">
                    {{ Form::password('confirm_password', ['class' => 'form-control', 'placeholder' => trans("front_messages.$modelName.confirm_password")]) }}
